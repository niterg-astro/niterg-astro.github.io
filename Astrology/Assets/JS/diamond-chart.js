d3.selectAll(".diamond-chart").each(function () {
    ...
    const circleRadius = 29; // Set radius for the circle

    // Append the circle in the middle of the rectangle
    svg.append("circle")
    ...
    const grahaPositions = [
        ...
        { x: 200, y: 120, class: "1-house fw-semibold", color: "maroon", value: "Su Me Ma Ju" },
        { x: 125, y: 70, class: "2-house fw-semibold", color: "maroon", value: "Ve" },
        { x: 80, y: 125, class: "3-house fw-semibold", color: "maroon", value: "" },
        { x: 110, y: 200, class: "4-house fw-semibold", color: "maroon", value: "" },
        { x: 80, y: 260, class: "5-house fw-semibold", color: "maroon", value: "Mo Ke" },
        { x: 125, y: 330, class: "6-house fw-semibold", color: "maroon", value: "" },
        { x: 200, y: 270, class: "7-house fw-semibold", color: "maroon", value: "" },
        { x: 275, y: 330, class: "8-house fw-semibold", color: "maroon", value: "" },
        { x: 330, y: 245, class: "9-house fw-semibold", color: "maroon", value: "" },
        { x: 290, y: 200, class: "10-house fw-semibold", color: "maroon", value: "" },
        { x: 320, y: 110, class: "11-house fw-semibold", color: "maroon", value: "Sa Ra" },
        { x: 275, y: 70, class: "12-house fw-semibold", color: "maroon", value: "" }
    ];
