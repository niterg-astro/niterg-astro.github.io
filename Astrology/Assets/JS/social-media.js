let media = document.getElementById("social_media");
media.innerHTML = `
        <div class="row">
            <div class="col-lg-8 col-md-12 col-sm-12 p-3 ">
                <div class="video">
                    <h2>Check out our new video in Youtube</h2>
                    <br>
                    <iframe
                        class="embed-responsive"
                        src="https://www.youtube.com/embed/bFyocxQ4zMc"
                ...
                <div class="row">
                    <div class="col-lg-8 col-sm-8">
                        ...
                        <h2 class="devanagari-text">श्रीमद् भगवद्गीता</h2>
                    </div>
                    <div class="col-lg-4 col-sm-4 text-end">
                        <h3>Chapter 1</h3>
                        <h2 class="devanagari-text">अध्याय १</h2>
                    </div>
                </div>
                <hr>
            </div>
                                    ...
                                    <div class="align-items-center">
                                        <div class="card-body">
                                            <div class="align-items-center justify-items-center">
                                                ...
                                                <br>
                                                <div class="card">
                                                    <a href="https://www.youtube.com/@niterg" target="_blank" class="btn btn-success">
                                                        <i class="bi bi-youtube p-2 "></i>
                                                        Subscribe
                                                    </a>
                                                </div>
